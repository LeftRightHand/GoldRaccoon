...
- (id<GRRequestProtocol>)addRequestForListDirectoryAtPath:(NSString *)path sucess:(void(^)(GRRequest *request, NSArray *listing))sucess failed:(void(^)(GRRequest *request, NSError *error))failed;
...
- (id<GRRequestProtocol>)addRequestForCreateDirectoryAtPath:(NSString *)path sucess:(void(^)(GRRequest *request))sucess failed:(void(^)(GRRequest *request, NSError *error))failed;
...
- (id<GRDataExchangeRequestProtocol>)addRequestForDownloadFileAtRemotePath:(NSString *)remotePath toLocalPath:(NSString *)localPath progress:(void(^)(float percent))progress sucess:(void(^)(GRRequest *request))sucess failed:(void(^)(GRRequest *request, NSError *error))failed;
...
- (id<GRDataExchangeRequestProtocol>)addRequestForUploadFileAtData:(NSData *)data toRemotePath:(NSString *)remotePath progress:(void(^)(float percent))progress sucess:(void(^)(GRRequest *request))sucess failed:(void(^)(GRRequest *request, NSError *error))failed;
